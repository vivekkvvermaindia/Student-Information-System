...
<div>
	<center><h1><font face="Calibri" color="White">PENDING REQUESTS</font></h1></center>
	...
	<table width="900" style="margin-left:200px" border="10">
		...
		<td bgcolor="red">
			<?php
			echo "<a href='approveuser.php?user_username=$user_username&valid=$user_valid'>APPROVE</a>";
			?>
		</td>
		<td bgcolor="red">
