...
<div>
	<nav >
			<ul >
    			<li><a href="mydetails_approve.php">Back</a></li>
				<li style="float:right"><a href="logout1.php">Log out</a></li>
			</ul>
    </nav>
		
</div>
<center><h1><font face ="Calibri" color="White">Student Detail</font></h1></center>
<?php
//echo $user;
$conn = mysqli_connect("localhost","root","","stud_db");
$sql = "select * from student_data where username = '$user'" ;
